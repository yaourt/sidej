...
public interface IRedisClient<K,V> {
	 ...
	 * 
	 */
	UpdateMe auth(final string password);
	 ...
	 * 
	 */
	UpdateMe echo(final string message);
	 ...
	 * 
	 */
	UpdateMe select(final integer index);
	 ...
	 * 
	 */
	UpdateMe del(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe exists(final K key, final key key);
	 ...
	 *     TTL mykey
	 */
	UpdateMe expire(final K key, final key key, final integer seconds);
	 ...
	 * 
	 */
	UpdateMe expireat(final K key, final key key, final long timestamp);
	 ...
	 * 
	 */
	UpdateMe keys(final pattern pattern);
	 ...
	 * 
	 */
	UpdateMe move(final K key, final key key, final integer db);
	 ...
	 * 
	 */
	UpdateMe object(final string subcommand, final string arguments);
	 ...
	 * 
	 */
	UpdateMe persist(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe rename(final K key, final key key, final K newkey, final key newkey);
	 ...
	 * 
	 */
	UpdateMe renamenx(final K key, final key key, final K newkey, final key newkey);
	 ...
	 * 
	 */
	UpdateMe sort(final K key, final key key, final pattern pattern, final [integer, integer] [offset, count], final string pattern, final enum order, final enum sorting, final K destination, final key destination);
	 ...
	 * 
	 */
	UpdateMe ttl(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe type(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe hdel(final K key, final key key, final string field);
	 ...
	 * 
	 */
	UpdateMe hexists(final K key, final key key, final string field);
	 ...
	 * 
	 */
	UpdateMe hget(final K key, final key key, final string field);
	 ...
	 * 
	 */
	UpdateMe hgetall(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe hincrby(final K key, final key key, final string field, final integer increment);
	 ...
	 * 
	 */
	UpdateMe hkeys(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe hlen(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe hmget(final K key, final key key, final string field);
	 ...
	 * 
	 */
	UpdateMe hmset(final K key, final key key, final [string, string] [field, value]);
	 ...
	 * 
	 */
	UpdateMe hset(final K key, final key key, final string field, final string value);
	 ...
	 * 
	 */
	UpdateMe hsetnx(final K key, final key key, final string field, final string value);
	 ...
	 * 
	 */
	UpdateMe hvals(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe blpop(final K key, final key key, final integer timeout);
	 ...
	 * 
	 */
	UpdateMe brpop(final K key, final key key, final integer timeout);
	 ...
	 */
	UpdateMe brpoplpush(final K source, final key source, final K destination, final key destination, final integer timeout);
	 ...
	 * 
	 */
	UpdateMe lindex(final K key, final key key, final integer index);
	 ...
	 * 
	 */
	UpdateMe linsert(final K key, final key key, final enum where, final string pivot, final string value);
	 ...
	 * 
	 */
	UpdateMe llen(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe lpop(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe lpush(final K key, final key key, final string value);
	 ...
	 * 
	 */
	UpdateMe lpushx(final K key, final key key, final string value);
	 ...
	 * 
	 */
	UpdateMe lrange(final K key, final key key, final integer start, final integer stop);
	 ...
	 * 
	 */
	UpdateMe lrem(final K key, final key key, final integer count, final string value);
	 ...
	 * 
	 */
	UpdateMe lset(final K key, final key key, final integer index, final string value);
	 ...
	 * 
	 */
	UpdateMe ltrim(final K key, final key key, final integer start, final integer stop);
	 ...
	 * 
	 */
	UpdateMe rpop(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe rpoplpush(final K source, final key source, final K destination, final key destination);
	 ...
	 * 
	 */
	UpdateMe rpush(final K key, final key key, final string value);
	 ...
	 * 
	 */
	UpdateMe rpushx(final K key, final key key, final string value);
	 ...
	 */
	UpdateMe publish(final string channel, final string message);
	 ...
	 */
	UpdateMe config set(final string parameter, final string value);
	 ...
	 * return
	 */
	UpdateMe debug object(final K key, final key key);
	 ...
	 * status-reply
	 */
	UpdateMe slaveof(final string host, final string port);
	 ...
	 * 
	 */
	UpdateMe sadd(final K key, final key key, final string member);
	 ...
	 * 
	 */
	UpdateMe scard(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe sdiff(final K key, final key key);
	 ...
	 */
	UpdateMe sdiffstore(final K destination, final key destination, final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe sinter(final K key, final key key);
	 ...
	 * integer-reply: the number of elements in the resulting set.
	 */
	UpdateMe sinterstore(final K destination, final key destination, final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe sismember(final K key, final key key, final string member);
	 ...
	 * 
	 */
	UpdateMe smembers(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe smove(final K source, final key source, final K destination, final key destination, final string member);
	 ...
	 * 
	 */
	UpdateMe spop(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe srandmember(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe srem(final K key, final key key, final string member);
	 ...
	 * 
	 */
	UpdateMe sunion(final K key, final key key);
	 ...
	 * integer-reply: the number of elements in the resulting set.
	 */
	UpdateMe sunionstore(final K destination, final key destination, final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe zadd(final K key, final key key, final double score, final string member);
	 ...
	 * 
	 */
	UpdateMe zcard(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe zcount(final K key, final key key, final double min, final double max);
	 ...
	 * 
	 */
	UpdateMe zincrby(final K key, final key key, final integer increment, final string member);
	 ...
	 * 
	 */
	UpdateMe zinterstore(final K destination, final key destination, final integer numkeys, final K key, final key key, final integer weight, final enum aggregate);
	 ...
	 * 
	 */
	UpdateMe zrange(final K key, final key key, final integer start, final integer stop, final enum withscores);
	 ...
	 * 
	 */
	UpdateMe zrangebyscore(final K key, final key key, final double min, final double max, final enum withscores, final [integer, integer] [offset, count]);
	 ...
	 * 
	 */
	UpdateMe zrank(final K key, final key key, final string member);
	 ...
	 * 
	 */
	UpdateMe zrem(final K key, final key key, final string member);
	 ...
	 * 
	 */
	UpdateMe zremrangebyrank(final K key, final key key, final integer start, final integer stop);
	 ...
	 * 
	 */
	UpdateMe zremrangebyscore(final K key, final key key, final double min, final double max);
	 ...
	 * 
	 */
	UpdateMe zrevrange(final K key, final key key, final integer start, final integer stop, final enum withscores);
	 ...
	 * 
	 */
	UpdateMe zrevrangebyscore(final K key, final key key, final double max, final double min, final enum withscores, final [integer, integer] [offset, count]);
	 ...
	 * 
	 */
	UpdateMe zrevrank(final K key, final key key, final string member);
	 ...
	 * 
	 */
	UpdateMe zscore(final K key, final key key, final string member);
	 ...
	 * 
	 */
	UpdateMe zunionstore(final K destination, final key destination, final integer numkeys, final K key, final key key, final integer weight, final enum aggregate);
	 ...
	 * 
	 */
	UpdateMe append(final K key, final key key, final string value);
	 ...
	 * 
	 */
	UpdateMe decr(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe decrby(final K key, final key key, final integer decrement);
	 ...
	 * 
	 */
	UpdateMe get(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe getbit(final K key, final key key, final integer offset);
	 ...
	 * 
	 */
	UpdateMe getrange(final K key, final key key, final integer start, final integer end);
	 ...
	 * 
	 */
	UpdateMe getset(final K key, final key key, final string value);
	 ...
	 * 
	 */
	UpdateMe incr(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe incrby(final K key, final key key, final integer increment);
	 ...
	 * 
	 */
	UpdateMe mget(final K key, final key key);
	 ...
	 * 
	 */
	UpdateMe mset(final [key, string] [key, value]);
	 ...
	 * 
	 */
	UpdateMe msetnx(final [key, string] [key, value]);
	 ...
	 * 
	 */
	UpdateMe set(final K key, final key key, final string value);
	 ...
	 * 
	 */
	UpdateMe setbit(final K key, final key key, final integer offset, final string value);
	 ...
	 * 
	 */
	UpdateMe setex(final K key, final key key, final integer seconds, final string value);
	 ...
	 * 
	 */
	UpdateMe setnx(final K key, final key key, final string value);
	 ...
	 * 
	 */
	UpdateMe setrange(final K key, final key key, final integer offset, final string value);
	 ...
	 * 
	 */
	UpdateMe strlen(final K key, final key key);
	 ...
	 * status-reply: always `OK`.
	 */
	UpdateMe watch(final K key, final key key);
